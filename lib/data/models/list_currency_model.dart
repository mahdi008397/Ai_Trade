...
class RawUsd {
  ...
  final String? lastmarket;
  final num? median;
  final num? toptiervolume24Hour;
  final num? toptiervolume24Hourto;
  final String? lasttradeid;
  final num? price;
  final int? lastupdate;
  final num? lastvolume;
  final num? lastvolumeto;
  final num? volumehour;
  final num? volumehourto;
  final num? openhour;
  final num? highhour;
  final num? lowhour;
  final num? volumeday;
  final num? volumedayto;
  final num? openday;
  final num? highday;
  final num? lowday;
  final num? volume24Hour;
  final num? volume24Hourto;
  final num? open24Hour;
  final num? high24Hour;
  final num? low24Hour;
  final num? change24Hour;
  final num? changepct24Hour;
  final num? changeday;
  final num? changepctday;
  final num? changehour;
  final num? changepcthour;
  final String? conversiontype;
  final String? conversionsymbol;
  ...
  final num? circulatingsupplymktcap;
  final num? totalvolume24H;
  final num? totalvolume24Hto;
  final num? totaltoptiervolume24H;
  final num? totaltoptiervolume24Hto;
  final String? imageurl;
